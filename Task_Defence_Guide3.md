...
When a user (or Postman) sends a request to `http://localhost:8082/students`:
...
5. The console will say Tomcat started on port 8082.
...
4. The console will confirm Tomcat started on port 8082.
...
- **Method**: `GET`
- **URL**: `http://localhost:8082/students/1`
...
- You can see it by going to `http://localhost:8082/application.wadl` in your browser.
